<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="RequestStatus2.aspx.cs" Inherits="RequestStatus2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Label ID="Label7" runat="server" 
        style="font-weight: 700; z-index: 1; left: 7px; top: 2px; position: absolute; height: 35px; width: 1283px; font-size: xx-large; color: #FFFFFF; text-align: center; background-color: #000066; right: -16px;" 
        Text="Request Status"></asp:Label>
    <asp:Label ID="Label8" runat="server" 
        style="z-index: 1; left: 221px; top: 46px; position: absolute; font-size: x-large; font-weight: 700; color: #006600; background-color: #FFFFFF" 
        Text="Track Your Status"></asp:Label>
    <asp:TextBox ID="TextBoxTrack" runat="server" 
        
            style="z-index: 1; left: 432px; top: 46px; position: absolute; height: 22px; width: 166px" 
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        CellPadding="0" DataKeyNames="UID" DataSourceID="SqlDataSource1" 
        ForeColor="Black" GridLines="None" 
        
            
            style="position: absolute; top: 85px; left: 10px; width: 1271px; z-index: 1; height: 93px; text-align: center;" 
        ...
        <asp:TextBox ID="TextBoxUID" runat="server" 
            style="z-index: 1; left: 1099px; top: 43px; position: absolute"></asp:TextBox>
        <asp:Label ID="LabelUID" runat="server" 
            style="z-index: 1; left: 1014px; top: 47px; position: absolute; font-weight: 700; color: #006600" 
            Text="Enter UID"></asp:Label>
    <div style="z-index: 1; left: 981px; top: 138px; position: absolute; height: 113px; width: 244px">
    ...
    <div style="position: absolute; top: 352px; left: 5px; height: 37px; z-index: 1; width: 1276px;">
        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
            ...
            style="position: absolute; top: 37px; left: 5px; width: 1265px; z-index: 1; height: 114px; text-align: center;" 
            PageSize="2">
            <AlternatingRowStyle BackColor="PaleGoldenrod" />
            <Columns>
        ...
        <asp:Label ID="Label10" runat="server" 
            style="z-index: 1; left: 3px; top: 3px; position: absolute; font-size: x-large; font-weight: 700; color: #FFFFFF; width: 1268px; height: 31px; text-align: center; background-color: #000066" 
