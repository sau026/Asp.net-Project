...
public partial class Director : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            DropDownList dlist = (row.Cells[12].FindControl("DropDownList1") as DropDownList);
    ...
    private void updatero(string Uid, String markstatus)
    {
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["UserDataConnectionString"].ConnectionString);
        conn.Open();
        string updtPrincipal = "UPDATE LeaveRequest set [DirectorCurrent] = @status, [Director] = @newstatus where UID='" + Uid + "'";
